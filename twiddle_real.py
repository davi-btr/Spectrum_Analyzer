...
twiddle_factors_real = [cmath.exp(2j*cmath.pi*n/1024).real for n in range(512)]

# Convert to 32-bit signed decimal values
twiddle_factors_decimal = [int(x*(-2**31)) for x in twiddle_factors_real]

# Create a Quartus MIF file
with open('twiddle_factors_real.mif', 'w') as f:
